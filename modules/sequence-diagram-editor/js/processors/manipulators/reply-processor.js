...
define(['d3', 'tree_node', 'app/ballerina/utils/module', 'app/ballerina/models/message-point', 'app/ballerina/models/message-link', 'resource_utils'],
    ...
    var ReplyProcessor = {
        id: "replyProcessor",
        title: "Reply",
        icon: ResourceConfigs.getContextAwarePath("images/tool-icons/left-arrow.svg"),
        colour : "#ffffff",
        type : "Action",
        editable : true,
        deletable: true,
        ...
        createCloneCallback : function(view){
            function cloneCallBack() {
                ...
                d3.xml(ResourceConfigs.getContextAwarePath("images/tool-icons/left-arrow.svg")).mimeType("image/svg+xml").get(function(error, xml) {
