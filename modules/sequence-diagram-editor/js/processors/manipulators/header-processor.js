...
define(['d3', 'tree_node', 'resource_utils'], function (d3, TreeNode, ResourceConfigs) {
    ...
    var HeaderProcessor = {
        id: "HeaderProcessor",
        title: "Header",
        icon: ResourceConfigs.getContextAwarePath("images/tool-icons/dgm-header.svg"),
        colour : "#ffffff",
        type : "UnitProcessor",
        ...
        createCloneCallback : function(view){
            function cloneCallBack() {
                ...
                d3.xml(ResourceConfigs.getContextAwarePath("images/tool-icons/dgm-header.svg")).mimeType("image/svg+xml").get(function(error, xml) {
