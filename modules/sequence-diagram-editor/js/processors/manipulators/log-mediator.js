...
define(['d3', 'tree_node', 'resource_utils'], function (d3, TreeNode, ResourceConfigs) {
    ...
    var LogMediator = {
        id: "LogMediator",
        title: "Logger",
        icon: ResourceConfigs.getContextAwarePath("images/tool-icons/dgm-logger.svg"),
        colour : "#ffffff",
        type : "UnitProcessor",
        width: 130,
        height: 45,
        ...
        createCloneCallback : function(view){
            function cloneCallBack() {
                ...
                d3.xml(ResourceConfigs.getContextAwarePath("images/tool-icons/dgm-logger.svg")).mimeType("image/svg+xml").get(function(error, xml) {
