...
define(['d3', 'tree_node', 'resource_utils'], function (d3, TreeNode, ResourceConfigs) {
    ...
    var ForkProcessor = {
        id: "ForkProcessor",
        title: "Fork",
        icon: ResourceConfigs.getContextAwarePath("images/tool-icons/dgm-fork.svg"),
        colour : "#27ae60",
        ...
        createCloneCallback : function(view){
            function cloneCallBack() {
                ...
                d3.xml(ResourceConfigs.getContextAwarePath("images/tool-icons/dgm-fork.svg")).mimeType("image/svg+xml").get(function(error, xml) {
