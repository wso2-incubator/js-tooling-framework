...
define(['d3', 'tree_node', 'resource_utils'], function (d3, TreeNode, ResourceConfigs) {
    ...
    var SwitchMediator = {
        id: "SwitchMediator",
        title: "Switch",
        icon: ResourceConfigs.getContextAwarePath("images/tool-icons/switch.svg"),
        colour : "#334455",
        ...
        createCloneCallback : function(view){
            function cloneCallBack() {
                ...
                d3.xml(ResourceConfigs.getContextAwarePath("images/tool-icons/switch_drag.svg")).mimeType("image/svg+xml").get(function(error, xml) {
